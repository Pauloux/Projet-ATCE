...
\textbf{Résonateur à quartz~:} Un quartz SMD Abracon ABM3 à 16~MHz (5,0$\times$3,2~mm, empreinte \texttt{Crystal\_SMD\_Abracon\_ABM3}) a été retenu pour sa précision, son faible encombrement, et sa compatibilité avec l’asservissement GPS. Il est également disponible chez Farnell à 0,258~€. \\
...
En comparaison avec la théorie, la fréquence de résonance attendue, calculée à partir du modèle Butterworth-van Dyke en annexe \cite{Modéle Butterworth} (L2 = 5~mH, C6 = 19,78929368~fF), is de $f_0 = \frac{1}{2\pi \sqrt{L2 \cdot C6}} \approx 16,009190$~MHz. L’écart entre la valeur mesurée (16,009200~MHz) et la valeur théorique (16,009190~MHz) est de 0,6~ppm, ce qui est négligeable et probablement dû aux capacités parasites et à la précision numérique de ngspice. Ces résultats valident la conception de l’oscillateur pour une utilisation dans l’asservissement GPS.

\section{Estimation du coût}

D'après le site Eurocircuits (voir Figure~\ref{fig:prix}), pour un prototype de PCB à 2 couches, le prix est de 40,99\euro{} (net) avec un délai de 3 jours. De plus, l'éditeur de classification indique que notre PCB est conçu en classe 6, ce qui correspond à des largeurs de pistes et des espacements plus exigeants.




\newpage
% Tableau complet avec toutes les données fournies
\begin{table}[ht]
\centering
\caption{Prix unitaire et total (en \euro{}) pour différentes quantités et délais}
...
\begin{thebibliography}{}
    ...
    \bibitem{Modéle Butterworth}
        Modéle de circuit Butterworth-Van Dyke : \url{https://demonstrations.wolfram.com/ButterworthVanDykeCircuit}

    \bibitem{USB OTG}
        USB OTG broche ID et câble : \url{https://www.astuces-pratiques.fr/informatique/usb-otg-broche-id-et-cable}
\end{thebibliography}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{tauR5C1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{voltageR5C1.png}
